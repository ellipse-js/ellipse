    ...
    handle: {
        ...
        value: function handle(req, res, fn, index) {
            ...
            if(index instanceof Function)
                return call.call(this.uncaughtError, fn, req, res, fn)
            ...
            for(var i = index || 0, l = routes.length; i < l; i++) {
                ...
                if(
                    ...
                    if(options)
                        this.chain(route, null, req, res, fn, i)
                    else {
            ...
            // it's all over, send 404
                ...
                call.call(this.notFound, res, req, res)
        }
    },
        ...
        value: function (route, match, params, req, res, fn, index) {
            ...
            function nextParam() {
                ...
                if (!param)
                    ...
                    call.call(param.handler, req, res, next, match[ param.index + 1 ])
            }
        }
    },
            ...
            function next(err, code, message) {
                ...
                // try to call the next handler function
                    ...
                    if(!options || handler instanceof Router || handler.prepareForRouter)
                        try {
                            call.call(handler, res, req, res, next)
                        }
                        catch (ex) {
                            error(ex, req, res)
                        }
                ...
                // it's all over, send 404
                    ...
                    call.call(self.notFound, res, req, res)
            }
        }
    },
