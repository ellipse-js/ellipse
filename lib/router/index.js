...
var Emitter       = require('events'),
    ...
    deprecate     = require('depd')('ellipse'),
    ...
    extendProto   = require('../utils/extendPrototypes'),
...
Object.defineProperties(Router.prototype, {
    ...
    addRoute: {
        value: function addRoute(method, path, handlers) {
            assert(typeof method === 'string', 'HTTP method must be a string.')
            assert(typeof path   === 'string', 'Route path must be a string.')
    ...
    subRoute: {
        value: function subRoute(mountPath) {
    ...
    // alias `subRoute` as `sub`
    sub: {
         value: function sub(mountPath) {
             return this.subRoute.apply(this, arguments)
         }
    },

    mount: {
        value: deprecate.function(function mount(mountPath) {
            return this.subRoute.apply(this, arguments)
        }, 'router.mount(): Use `router.subRoute(path)` or `router.sub(path)` instead.')
    },
